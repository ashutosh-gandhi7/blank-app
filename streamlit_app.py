...
SUPPORTED_APPS = ["mmx", "FAST", "insightsai", "mmm", "patient_claims", "fast1", "insightsai1","ihub","salesmate","access_iq","insights_engine", "payer_spine", "kol", "data_stewardship", "gapd", "mr_insights_engine"]
APP_NAME_ALIAS = {
