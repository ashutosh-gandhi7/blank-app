...
SUPPORTED_APPS = ["mmx", "FAST", "insightsai", "mmm", "patient_claims", "fast1", "insightsai1","ihub","salesmate","access_iq","insights_engine", "payer_spine", "kol", "data_stewardship", "gapd"]
APP_NAME_ALIAS = {
